      ...
      <div id="accordion" class="accordion" data-accordion>
        <div class="card" v-for="(item,index) in this.$store.state.challenges" :key="item.key">
          ...
          <div class="collapse show" :id="'collapse-'+index" >
            ...
            <div class="card-body">
              <Games v-bind:games="item.games" v-bind:index="index" />
            </div>
            <div class="card-body">
              <Challenge v-bind:challenge="item.productivity" v-bind:name="'Productivity'" />
            </div>
            <div class="card-body">
              <Challenge v-bind:challenge="item.reading" v-bind:name="'Reading'" />
            </div>
            <div class="card-body">
              <Challenge v-bind:challenge="item.health" v-bind:name="'Health'" />
            </div>
            <!-- <div class="card-body">
              <Challenge v-bind:challenge="item.reading" v-bind:name="'Reading'" />
            </div> -->
